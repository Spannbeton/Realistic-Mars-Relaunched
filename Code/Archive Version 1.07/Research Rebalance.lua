...
local ResearchDescOn = {
    ScienceInstitute = T{"Generates Research. An early Mars colony can support only one of these. Planetary research assets are scarce; extra capacity belongs in micro-G on asteroids."},
    ResearchLab = T{"Generates Research. An early Mars colony can support only one of these. Planetary research assets are scarce; extra capacity belongs in micro-G on asteroids."},
    NetworkNode = T{"Increases the Research output of all Research buildings in its Dome. An early Mars colony can support only one of these."},
    LowGLab = T{"Generates Research. An early Mars colony can support only one of these. Surface labs stay unique; extra capacity belongs in micro-G on asteroids."},
