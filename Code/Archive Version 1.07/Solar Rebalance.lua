...
local SolarDescOn = {
    SolarPanel = T{"Generates Power during daytime. Closes during Dust Storms. Protected from dust while turned off. Dust buildup reduces Power output, up to the configured loss at full maintenance."},
    SolarPanelBig = T{"Generates Power during daytime. Closes during Dust Storms. Protected from dust while turned off. Dust buildup reduces Power output, up to the configured loss at full maintenance."},
    SolarArray = T{"An advanced solar array that generates Power during daytime. Does not produce Power during Dust Storms. Requires less maintenance than regular Solar Panels, but can't be closed. Dust buildup reduces Power output, up to the configured loss at full maintenance."},
}
