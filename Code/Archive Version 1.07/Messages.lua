...
local function RMR_IntroText()
    ...
    if Opt("Wonder_Rebalance") then
        parts[#parts + 1] = T{"\n\n<em>Wonders</em>\nA wonder is familiar technology in ceremonial dress, billed as a cathedral. The Telescope is an expensive pair of eyes. The Mohole is a mine that does not empty and does not cease to consume power and labour. Both are useful. Neither is, by default, the wiser expenditure."}
    end
