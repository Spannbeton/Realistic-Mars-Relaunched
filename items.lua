return {
	...
	PlaceObj('ModItemFolder', {
		...
		PlaceObj('ModItemOptionToggle', {
			...
			'Help', "Sets deposit counts and sizes on new surface maps. Counts are exact. Each deposit rolls 80–100% of its size cap. 0 means none. Grade stays vanilla. Asteroid and cave maps are unchanged. Off restores vanilla presets.",
			'DefaultValue', true,
		}),
		PlaceObj('ModItemOptionNumber', {
			'name', "Resource_Metals_NormalDeposits",
			'DisplayName', "Metals normal deposits",
			'Help', "Exact number of shallow Metals deposits. Each holds about 25% of the deep size. 0 places none.",
			'DefaultValue', 2,
			'MaxValue', 20,
		}),
		PlaceObj('ModItemOptionNumber', {
			'name', "Resource_Metals_DeepDeposits",
			'DisplayName', "Metals deep deposits",
			'Help', "Exact number of deep Metals deposits. 0 places none.",
			'DefaultValue', 1,
			'MaxValue', 20,
		}),
		PlaceObj('ModItemOptionNumber', {
			...
			'Help', "Deep-deposit size cap. Shallow deposits use 25% of this. Each deposit rolls 80–100% of its cap. 0 leaves empty deposits.",
			'DefaultValue', 10000,
			'MaxValue', 100000,
			'StepSize', 1000,
		}),
		PlaceObj('ModItemOptionNumber', {
			'name', "Resource_Water_NormalDeposits",
			'DisplayName', "Water normal deposits",
			'Help', "Exact number of shallow Water deposits. Each holds about 25% of the deep size. 0 places none.",
			'DefaultValue', 3,
			'MaxValue', 20,
		}),
		PlaceObj('ModItemOptionNumber', {
			'name', "Resource_Water_DeepDeposits",
			'DisplayName', "Water deep deposits",
			'Help', "Exact number of deep Water deposits. 0 places none.",
			'DefaultValue', 2,
			'MaxValue', 20,
		}),
		PlaceObj('ModItemOptionNumber', {
		...
		PlaceObj('ModItemOptionNumber', {
			'name', "Resource_PreciousMetals_NormalDeposits",
			'DisplayName', "Rare Metals normal deposits",
			'Help', "Exact number of shallow Rare Metals deposits. Each holds about 25% of the deep size. 0 places none.",
			'DefaultValue', 2,
			'MaxValue', 20,
		}),
		PlaceObj('ModItemOptionNumber', {
			'name', "Resource_PreciousMetals_DeepDeposits",
			'DisplayName', "Rare Metals deep deposits",
			'Help', "Exact number of deep Rare Metals deposits. 0 places none.",
			'DefaultValue', 1,
			'MaxValue', 20,
		}),
		PlaceObj('ModItemOptionNumber', {
		...
		PlaceObj('ModItemOptionNumber', {
			'name', "Resource_Concrete_Patches",
			'DisplayName', "Concrete patches",
			'Help', "Exact number of surface concrete patches, split across vanilla size tiers. 0 places none.",
			'DefaultValue', 12,
			'MaxValue', 40,
		}),
		PlaceObj('ModItemOptionNumber', {
			'name', "Resource_Concrete_MaxAmount",
			'DisplayName', "Resources per concrete patch",
			'Help', "Size cap of each concrete patch. Each patch rolls 80–100% of this cap. 0 leaves empty patches.",
			'DefaultValue', 800,
			'MaxValue', 10000,
			'StepSize', 100,
		}),
	...
	PlaceObj('ModItemFolder', {
		'name', "Rival and Faction Rebalance",
	}, {
		PlaceObj('ModItemCode', {
		...
		PlaceObj('ModItemCode', {
			'name', "Rival UI",
			'CodeFileName', "Code/Rival UI.lua",
		}),
		PlaceObj('ModItemCode', {
			'name', "Rival POI",
			'CodeFileName', "Code/Rival POI.lua",
		}),
		PlaceObj('ModItemCode', {
			'name', "Faction Screen",
			'CodeFileName', "Code/Faction Screen.lua",
		}),
		PlaceObj('ModItemOptionToggle', {
		...
		PlaceObj('ModItemCode', {
			'name', "Faction Rebalance",
			'CodeFileName', "Code/Faction Rebalance.lua",
		}),
		PlaceObj('ModItemOptionToggle', {
			'name', "Faction_Rebalance",
			'DisplayName', "Faction Rebalance",
			'Help', "Faction mood reaches the supporters. Approval above content helps comfort and morale. Below it, both fall. Breaking point also drains sanity. The Assembly shifts the effect one step upward.",
			'DefaultValue', true,
		}),
		}),
	PlaceObj('ModItemFolder', {
		'name', "Sponsor Rebalance",
	}, {
		PlaceObj('ModItemCode', {
			'name', "Sponsor Rebalance",
			'CodeFileName', "Code/Sponsor Rebalance.lua",
		}),
		PlaceObj('ModItemOptionToggle', {
