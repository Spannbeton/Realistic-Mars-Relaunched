...
local function PoliticsLog(context)
	...
	local lines = {}
	lines[#lines + 1] = T{"<style PGSponsorInfo>Increase Standing Target by:</style>"}
	...
	if #red > 0 then
		lines[#lines + 1] = T{"<style PGSponsorInfo><color 220 190 50>Negative Factors:</color></style>"}
